    ...
    route() {
        ...
        this.app.get('/register/play/:AA/:code/:name', function(req, res) {
            ...
            if (AAtoCODE.get(AA) === code) {
                res.redirect(`https://under-the-ksa.herokuapp.com/play/${AA}/${code}/${name}`);
            } else {
                res.redirect('https://under-the-ksa.herokuapp.com/register')
            }
        });
        ...
        this.app.get('/register/spectate/:AA/:code', function(req, res, next) {
            ...
            const code = req.params.code;
            if (AAtoCODE.get(AA) === code) {
                res.redirect(`https://under-the-ksa.herokuapp.com/spectate/${AA}/${code}`);
            } else {
                res.redirect('https://under-the-ksa.herokuapp.com/register');
            }
        });
